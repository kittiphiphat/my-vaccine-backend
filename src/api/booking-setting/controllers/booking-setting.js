...
async update(ctx) {
  ...
  // ✅ รองรับทั้งจาก REST และ Admin Panel
  const body = ctx.request.body.data || ctx.request.body;
  ...
  console.log('[🔧 Update Data]', updateData); // ✅ ตรวจสอบค่าจริง
